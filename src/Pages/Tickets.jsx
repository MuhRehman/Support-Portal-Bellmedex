...
import CreateTaskModalComp from '../Components/CreateTaskModalComp';
...
export default function Tickets() {
 ...
 <div class="flex px-5 py-0 shadow-md items-center justify-between border-b-2 font-sans bg-sideNavbg">
     ...
     <div class="text-right">
      ...
      </i><span class="text-blue-500"> </span>
      ...
      <div class="flex">
        ...
        <button type="button"  onClick={handleOpenModal} class="flex items-center text-md px-2 me-2 mb-1 mt-1 py-[2px] bg-white rounded-lg text-gray-700">
   ...
   <CreateTaskModalComp  isOpen={isModalOpen} onClose={handleCloseModal} ></CreateTaskModalComp>
    </>
  )
}
